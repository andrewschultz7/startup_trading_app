...
def main():
    ...
    Button(dialog_main, text="Run", command=run_applications).grid(row=4, column=1,sticky=W, pady=4)
    Button(dialog_main, text="Quit", command=dialog_main.quit).grid(row=4, column=2,sticky=W, pady=4)
    mainloop()
